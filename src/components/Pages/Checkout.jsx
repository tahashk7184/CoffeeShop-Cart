...
import Easypessalogo from "../../assets/easypessalogo.png"

const Checkout = ({ cart, setCart }) => {
    const [showForm, setShowForm] = useState(false);
    const [formData, setFormData] = useState({ name: '', phone: '', address: '', paymentMethod: '' });
...
Payment Method: ${formData.paymentMethod}
        ...
        const whatsappUrl = `https://wa.me/923164735315?text=${encodedOrder}`;
    ...
    return (
        <div className="container py-10 px-4 sm:px-6 lg:px-8">
            ...
            {showForm ? (
                <form onSubmit={handleFormSubmit} className="bg-white shadow-lg rounded-lg p-6 sm:p-8 mb-10 mx-auto max-w-lg">
                    <h2 className="text-xl sm:text-2xl font-semibold mb-6">Customer Information</h2>
                    <div className="mb-4">
                    ...
                    <div className="mb-4">
                        <label className="block text-base sm:text-lg font-medium mb-2">Phone Number</label>
                        <input
                            type="tel"
                            name="phone"
                    ...
                    <div className="mb-4">
                        <label className="block text-base sm:text-lg font-medium mb-2">Address</label>
                        <textarea
                            name="address"
                    ...
                    <div className="mb-4">
                        <label className="block text-base sm:text-lg font-medium mb-2">Payment Method</label>
                    ...
                    {formData.paymentMethod === 'Bank Transfer' && (
                        <div className="mb-4 bg-gray-50 p-4 rounded-lg border border-gray-300">
                            ...
                            <p className="text-md pb-5">Send Screenshot of Payment in WhatsApp Chat.</p>
                            <div className='space-y-4 md:space-y-6'>
                                <div className="border p-4 rounded bg-white shadow-sm">
                                    <div className="flex flex-col md:flex-row items-center md:space-x-4">
                                        <img src={Banklogo} alt="Bank Logo" className="w-16 h-16 object-cover mb-4 md:mb-0" />
                                        <div className="text-center md:text-left">
                                            <p className="font-semibold">Bank: ALLIED BANK LIMITED</p>
                                            <p>Account Name: Taha Sheikh</p>
                                            <p>Account Number: PK75ABPA0010071002260018</p>
                                        </div>
                                    </div>
                                </div>
                                <div className="border p-4 rounded bg-white shadow-sm">
                                    <div className="flex flex-col md:flex-row items-center md:space-x-4">
                                        <img src={Easypessalogo} alt="EasyPaisa Logo" className="w-16 h-16 object-cover mb-4 md:mb-0" />
                                        <div className="text-center md:text-left">
                                            <p className="font-semibold">Bank: EASY PAISA</p>
                                            <p>Account Name: Taha Sheikh</p>
                                            <p>Account Number: 03150007184</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="bg-white shadow-lg rounded-lg p-6 sm:p-8 mb-10 mx-auto max-w-3xl">
                        ...
                        {cart.length === 0 ? (
                            <div className="text-center text-gray-500 py-10">
                                <h3 className="text-lg sm:text-xl font-medium">Your cart is empty.</h3>
                                <p className="mt-2">Add some items to your cart to proceed with checkout.</p>
                            </div>
                        ) : (
                            <>
                                ...
                                <div className="mt-6 text-right">
                                    <h2 className="text-xl sm:text-2xl font-bold">Total: PKR {total}</h2>
                                </div>
                                <button
